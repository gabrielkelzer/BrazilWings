...
copiar_app_smsbomber = lambda: os.system('git clone https://github.com/Matheus33013301/HeleV1/blob/master/Smsbomber.apk;cp -i Smsbomber.apk /data/data/com.termux/files/home/storage/downloads')
abrir_site_livro = lambda: os.system('termux-open-url https://clubedeautores.com.br/livro/achado-nao-e-roubado-2')
sleep = lambda: os.system('sleep 3')
